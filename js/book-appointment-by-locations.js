    ...
    try {
      ...
      const dataLayerPush = (event) => {
        ...
        try {
          ...
          setTimeout(() => {
            ...
            if (
              window.$shedulerShadowRoot.querySelector("textarea") &&
              comment &&
              window.$shedulerShadowRoot
            ) {
              console.log("Comment:", comment);
              $(window.$shedulerShadowRoot.querySelector("textarea")).val(
                `Offer: ${comment}`
              );
            }
      ...
      window.jarvis.onBookSuccesshandlers.push(function () {
        ...
        setTimeout(() => {
          ...
          ).text("We've sent an email and text to:");
          $(
            window.$shedulerShadowRoot.querySelector(
              "#app>div.flex.flex.flex-col.flex-grow.mt-6>div.flex.flex-col.flex-grow>div>div>div>h3"
            )
          ).text("Last step!");
          ...
          $(".book-an-appointment-container").css("padding", "0px 0px 0px 0px");
          $(
          ...
          ).css("background-color", "#6AC64B");
          $(".book-an-appointement-bg-wrapper").css("padding", "0");
          $(
            window.$shedulerShadowRoot.querySelector(
              "#app > div.flex.flex-col.flex-grow.mt-6 > div.container.mx-auto"
            )
          ).hide();
          $(".book-an-appointment-main").css("width", "100%");
          $(
            window.$shedulerShadowRoot.querySelector(
              "#app > div.flex.flex-col.flex-grow.mt-6 > div.flex.flex-col.flex-grow > div > div > div"
            )
      ...
      $("#wf-back-button-mobile").attr("onclick", "jarvisGoBack()");
      $("#back-button-sticky-mobile").attr("onclick", "jarvisGoBack()");
      $("#back-button-sticky").attr("onclick", "jarvisGoBack()");
      $("#next-button-sticky").click(function () {
        window.$shedulerShadowRoot.querySelector(".continue-btn").click();
      });
      window.addEventListener("load", async function () {
        try {
              ...
              if (mutation.type === "childList") {
                ...
                requestAnimationFrame(() => {
                  ...
                  if (
                    ...
                    ).after("<div class='separator-line'></div>");
                  }
                  ...
                  if (
                    ...
                    $(
                      ...
                      .after("<div class='separator-line-3steps-2'></div>")
                      .before("<div class='separator-line-3steps-1'></div>");
                    window.$shedulerShadowRoot.querySelector(
                      "#app>div.flex.flex-col.flex-grow.mt-6>div>div>div.flex.justify-center"
                  ...
                  if (
                    ...
                    $("#next-button-sticky").css({
                      opacity: "0.5",
                      cursor: "not-allowed",
                    });
                    $("#next-button-sticky").attr("disabled", "disabled");
                  } else {
                    $("#next-button-sticky").css({
                      opacity: "1",
                      cursor: "pointer",
                    });
                    $("#next-button-sticky").removeAttr("disabled");
                  }

                  const back_button = window.$shedulerShadowRoot.querySelector(
                    "#app > div.flex.flex-col.flex-grow.mt-6 > form > div.z-50.flex-grow.py-6.mt-6.bg-color.shadow-2xl > div > div > div a"
                  );
                  if (back_button) {
                    $("#back-button-sticky-mobile, #back-button-sticky").css(
                      "opacity",
                      "1"
                    );
                    $("#back-button-sticky-mobile, #back-button-sticky").css(
                    ...
                    $("#wf-back-button-mobile").show();
                  } else {
                    $("#back-button-sticky-mobile, #back-button-sticky").css(
                      "opacity",
                      "0"
                    );
                    $("#wf-back-button-mobile").hide();
                  }
                  if (
                    window.$shedulerShadowRoot.querySelector(
                      "#app > div.flex.flex-col.flex-grow.mt-6 > div.flex.flex-col.flex-grow > div > div > div"
                  ...
                  if (
                    ...
                    $(
                      ...
                      // Detach the event handlers using their namespaces
                      // Detach first name sync handler
                      $(
                        window.$shedulerShadowRoot.querySelector(
                          "input#first_name"
                        )
                      ).off("change.first_name_sync");
                      // Detach last name sync handler
                      $(
                        window.$shedulerShadowRoot.querySelector(
                          "input#last_name"
                        )
                      ).off("change.last_name_sync");
                      // Detach birth date sync handler
                      $(
                        window.$shedulerShadowRoot.querySelector(
                          "input#birth_date"
                        )
                      ).off("change.birth_date_sync");
                    });
                    ...
                    $(
                      ...
                      // Sync the initial values from first name, last name, and birth date
                      $(
                        window.$shedulerShadowRoot.querySelector(
                          "input#policy_holders_firstname"
                        )
                      ...
                      // Attach event handlers with namespace for syncing real-time changes
                      // Sync changes in first name
                      $(
                        window.$shedulerShadowRoot.querySelector(
                          "input#first_name"
                        )
                      ).on("change.first_name_sync", function () {
                        $(
                          window.$shedulerShadowRoot.querySelector(
                            "input#policy_holders_firstname"
                          )
                      ...
                      // Sync changes in last name
                      $(
                        window.$shedulerShadowRoot.querySelector(
                          "input#last_name"
                        )
                      ).on("change.last_name_sync", function () {
                        $(
                          window.$shedulerShadowRoot.querySelector(
                            "input#policy_holders_lastname"
                          )
                      ...
                      // Sync changes in birth date
                      $(
                        window.$shedulerShadowRoot.querySelector(
                          "input#birth_date"
                        )
                      ).on("change.birth_date_sync", function () {
                        $(
                          window.$shedulerShadowRoot.querySelector(
                            "input#policy_holders_dob"
                          )
                  ...
                  const dropdownDiv = window.$shedulerShadowRoot.querySelector(
          ...
          observer.observe(window.$shedulerShadowRoot, config);
          //}
          //},0)
